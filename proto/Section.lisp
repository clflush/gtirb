...
(cl:defclass section (pb:protocol-buffer)
  ...
  (byte-intervals
   ...
   :initarg :byte-intervals
   :initform (cl:make-array
              0
              :element-type 'proto::byte-interval
              :fill-pointer 0 :adjustable cl:t)
   :type (cl:vector proto::byte-interval))
  (section-flags
   :accessor section-flags
   :initarg :section-flags
   :initform (cl:make-array
              0
              :element-type 'proto::section-flag
              :fill-pointer 0 :adjustable cl:t)
   :type (cl:vector proto::section-flag))
  (%has-bits%
   :accessor %has-bits%
   :initform 0
...
(cl:defmethod cl:initialize-instance :after
  ((self section) cl:&key
                  (uuid cl:nil uuid-p)
                  (name cl:nil name-p)
                  (byte-intervals cl:nil byte-intervals-p)
                  (section-flags cl:nil section-flags-p)
                  )
  (cl:declare (cl:ignore uuid name byte-intervals section-flags))
  (cl:when uuid-p
    (cl:setf (cl:ldb (cl:byte 1 0) (cl:slot-value self '%has-bits%)) 1))
  (cl:when name-p
    (cl:setf (cl:ldb (cl:byte 1 1) (cl:slot-value self '%has-bits%)) 1))
  (cl:when byte-intervals-p
    (cl:setf (cl:ldb (cl:byte 1 2) (cl:slot-value self '%has-bits%)) 1))
  (cl:when section-flags-p
...
(cl:defmethod clear-byte-intervals ((self section))
  (cl:setf (cl:slot-value self 'byte-intervals)
           (cl:make-array 0 :element-type 'proto::byte-interval
            :fill-pointer 0 :adjustable cl:t))
  (cl:values))
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
