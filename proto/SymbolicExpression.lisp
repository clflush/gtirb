...
(cl:defmethod cl:initialize-instance :after
  ((self sym-stack-const) cl:&key
                  (offset cl:nil offset-p)
                  (symbol-uuid cl:nil symbol-uuid-p)
                  )
  (cl:declare (cl:ignore offset symbol-uuid))
  (cl:when offset-p
    (cl:setf (cl:ldb (cl:byte 1 0) (cl:slot-value self '%has-bits%)) 1))
  (cl:when symbol-uuid-p
...
(cl:defclass sym-addr-addr (pb:protocol-buffer)
  ...
  (symbol1-uuid
   ...
   :initarg :symbol1-uuid
   :initform (cl:make-array 0 :element-type '(cl:unsigned-byte 8))
   :type (cl:simple-array (cl:unsigned-byte 8) (cl:*)))
  (symbol2-uuid
   :accessor symbol2-uuid
   :initarg :symbol2-uuid
   :initform (cl:make-array 0 :element-type '(cl:unsigned-byte 8))
   :type (cl:simple-array (cl:unsigned-byte 8) (cl:*)))
  (%has-bits%
   :accessor %has-bits%
...
(cl:defmethod cl:initialize-instance :after
  ((self sym-addr-addr) cl:&key
                  (scale cl:nil scale-p)
                  (offset cl:nil offset-p)
                  (symbol1-uuid cl:nil symbol1-uuid-p)
                  (symbol2-uuid cl:nil symbol2-uuid-p)
                  )
  (cl:declare (cl:ignore scale offset symbol1-uuid symbol2-uuid))
  (cl:when scale-p
    (cl:setf (cl:ldb (cl:byte 1 0) (cl:slot-value self '%has-bits%)) 1))
  (cl:when offset-p
    (cl:setf (cl:ldb (cl:byte 1 1) (cl:slot-value self '%has-bits%)) 1))
  (cl:when symbol1-uuid-p
    (cl:setf (cl:ldb (cl:byte 1 2) (cl:slot-value self '%has-bits%)) 1))
  (cl:when symbol2-uuid-p
...
(cl:defclass symbolic-expression (pb:protocol-buffer)
  ...
  (stack-const
   ...
   :initarg :stack-const
   :initform cl:nil
   :type (cl:or cl:null proto::sym-stack-const))
  (addr-const
   :writer (cl:setf addr-const)
   :initarg :addr-const
   :initform cl:nil
   :type (cl:or cl:null proto::sym-addr-const))
  (addr-addr
   :writer (cl:setf addr-addr)
   :initarg :addr-addr
   :initform cl:nil
   :type (cl:or cl:null proto::sym-addr-addr))
  (%has-bits%
   :accessor %has-bits%
   :initform 0
...
(cl:defmethod cl:initialize-instance :after
  ((self symbolic-expression) cl:&key
                  (stack-const cl:nil stack-const-p)
                  (addr-const cl:nil addr-const-p)
                  (addr-addr cl:nil addr-addr-p)
                  )
  (cl:declare (cl:ignore stack-const addr-const addr-addr))
  (cl:when stack-const-p
    (cl:setf (cl:ldb (cl:byte 1 0) (cl:slot-value self '%has-bits%)) 1))
  (cl:when addr-const-p
    (cl:setf (cl:ldb (cl:byte 1 1) (cl:slot-value self '%has-bits%)) 1))
  (cl:when addr-addr-p
    (cl:setf (cl:ldb (cl:byte 1 2) (cl:slot-value self '%has-bits%)) 1))
  )
...
(cl:defmethod stack-const ((self symbolic-expression))
  (cl:let ((result (cl:slot-value self 'stack-const)))
    (cl:when (cl:null result)
      (cl:setf result (cl:make-instance 'proto::sym-stack-const))
...
(cl:defmethod addr-const ((self symbolic-expression))
  (cl:let ((result (cl:slot-value self 'addr-const)))
    (cl:when (cl:null result)
      (cl:setf result (cl:make-instance 'proto::sym-addr-const))
...
(cl:defmethod addr-addr ((self symbolic-expression))
  (cl:let ((result (cl:slot-value self 'addr-addr)))
    (cl:when (cl:null result)
      (cl:setf result (cl:make-instance 'proto::sym-addr-addr))
...
(cl:defmethod pb:octet-size ((self symbolic-expression))
  (cl:let ((size 0))
    ;; .proto.SymStackConst stack_const = 1[json_name = "stackConst"];
    (cl:when (cl:logbitp 0 (cl:slot-value self '%has-bits%))
      (cl:let ((s (pb:octet-size (cl:slot-value self 'stack-const))))
        (cl:incf size (cl:+ 1 s (varint:length32 s)))))
    ;; .proto.SymAddrConst addr_const = 2[json_name = "addrConst"];
    (cl:when (cl:logbitp 1 (cl:slot-value self '%has-bits%))
      (cl:let ((s (pb:octet-size (cl:slot-value self 'addr-const))))
        (cl:incf size (cl:+ 1 s (varint:length32 s)))))
    ;; .proto.SymAddrAddr addr_addr = 3[json_name = "addrAddr"];
    (cl:when (cl:logbitp 2 (cl:slot-value self '%has-bits%))
          ...
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:let ((message (cl:slot-value self 'stack-const)))
              (cl:when (cl:null message)
                (cl:setf message (cl:make-instance 'proto::sym-stack-const))
        ...
        ((18)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:let ((message (cl:slot-value self 'addr-const)))
              (cl:when (cl:null message)
                (cl:setf message (cl:make-instance 'proto::sym-addr-const))
        ...
        ((26)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:let ((message (cl:slot-value self 'addr-addr)))
              (cl:when (cl:null message)
                (cl:setf message (cl:make-instance 'proto::sym-addr-addr))
