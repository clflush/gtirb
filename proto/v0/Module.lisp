...
(cl:defmethod cl:initialize-instance :after
  ((self module-symbolic-operands-entry) cl:&key
                  (key cl:nil key-p)
...
(cl:defmethod cl:initialize-instance :after
  ((self module) cl:&key
                  ...
                  (isa-id cl:nil isa-id-p)
                  (name cl:nil name-p)
                  (image-byte-map cl:nil image-byte-map-p)
                  ...
                  (symbolic-operands cl:nil symbolic-operands-p)
                  (aux-data-container cl:nil aux-data-container-p)
                  )
  (cl:declare (cl:ignore uuid binary-path preferred-addr rebase-delta file-format isa-id name image-byte-map symbols cfg blocks data proxies sections symbolic-operands aux-data-container))
  (cl:when uuid-p
    (cl:setf (cl:ldb (cl:byte 1 0) (cl:slot-value self '%has-bits%)) 1))
