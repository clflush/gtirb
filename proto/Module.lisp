...
(cl:deftype isa () '(cl:member 0 1 2 3 4 5))
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
  (cl:export 'isa))
...
(cl:defconstant +maximum-isa+ +isa-valid-but-unsupported+)
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
...
(cl:defclass module-aux-data-entry (pb:protocol-buffer)
  ...
  (value
   ...
   :initarg :value
   :initform cl:nil
   :type (cl:or cl:null proto::aux-data))
  (%has-bits%
   :accessor %has-bits%
   :initform 0
...
(cl:defmethod cl:initialize-instance :after
  ((self module-aux-data-entry) cl:&key
                  (key cl:nil key-p)
                  (value cl:nil value-p)
                  )
  (cl:declare (cl:ignore key value))
  (cl:when key-p
...
(cl:defmethod value ((self module-aux-data-entry))
  (cl:let ((result (cl:slot-value self 'value)))
    (cl:when (cl:null result)
      (cl:setf result (cl:make-instance 'proto::aux-data))
...
(cl:defclass module (pb:protocol-buffer)
  ...
  (preferred-addr
   ...
   :initarg :preferred-addr
   :initform 0
   :type (cl:unsigned-byte 64))
  (rebase-delta
   :accessor rebase-delta
   :initarg :rebase-delta
   :initform 0
   :type (cl:signed-byte 64))
  (file-format
   :accessor file-format
   :initarg :file-format
   :initform proto::+file-format-format-undefined+
   :type proto::file-format)
  (isa
   :accessor isa
   :initarg :isa
   :initform proto::+isa-isa-undefined+
   :type proto::isa)
  (name
   :accessor name
   :initarg :name
  ...
  (symbols
   ...
   :initform (cl:make-array
              0
              :element-type 'proto::symbol
              :fill-pointer 0 :adjustable cl:t)
   :type (cl:vector proto::symbol))
  (proxies
   :accessor proxies
   :initarg :proxies
   :initform (cl:make-array
              0
              :element-type 'proto::proxy-block
              :fill-pointer 0 :adjustable cl:t)
   :type (cl:vector proto::proxy-block))
  (sections
   :accessor sections
   :initarg :sections
   :initform (cl:make-array
              0
              :element-type 'proto::section
              :fill-pointer 0 :adjustable cl:t)
   :type (cl:vector proto::section))
  (aux-data
   :accessor aux-data
   :initarg :aux-data
   :initform (cl:make-array
              0
              :element-type 'proto::module-aux-data-entry
              :fill-pointer 0 :adjustable cl:t)
   :type (cl:vector proto::module-aux-data-entry))
  (entry-point
...
(cl:defmethod cl:initialize-instance :after
  ((self module) cl:&key
                  (uuid cl:nil uuid-p)
                  (binary-path cl:nil binary-path-p)
                  (preferred-addr cl:nil preferred-addr-p)
                  (rebase-delta cl:nil rebase-delta-p)
                  (file-format cl:nil file-format-p)
                  (isa cl:nil isa-p)
                  (name cl:nil name-p)
                  (symbols cl:nil symbols-p)
                  (proxies cl:nil proxies-p)
                  (sections cl:nil sections-p)
                  (aux-data cl:nil aux-data-p)
                  (entry-point cl:nil entry-point-p)
                  )
  (cl:declare (cl:ignore uuid binary-path preferred-addr rebase-delta file-format isa name symbols proxies sections aux-data entry-point))
  (cl:when uuid-p
    (cl:setf (cl:ldb (cl:byte 1 0) (cl:slot-value self '%has-bits%)) 1))
  (cl:when binary-path-p
    (cl:setf (cl:ldb (cl:byte 1 1) (cl:slot-value self '%has-bits%)) 1))
  (cl:when preferred-addr-p
    (cl:setf (cl:ldb (cl:byte 1 2) (cl:slot-value self '%has-bits%)) 1))
  (cl:when rebase-delta-p
    (cl:setf (cl:ldb (cl:byte 1 3) (cl:slot-value self '%has-bits%)) 1))
  (cl:when file-format-p
...
(cl:defmethod clear-file-format ((self module))
  (cl:setf (cl:slot-value self 'file-format) proto::+file-format-format-undefined+)
...
(cl:defmethod clear-isa ((self module))
  (cl:setf (cl:slot-value self 'isa) proto::+isa-isa-undefined+)
...
(cl:defmethod clear-symbols ((self module))
  (cl:setf (cl:slot-value self 'symbols)
           (cl:make-array 0 :element-type 'proto::symbol
            :fill-pointer 0 :adjustable cl:t))
  (cl:values))
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
...
(cl:defmethod clear-proxies ((self module))
  (cl:setf (cl:slot-value self 'proxies)
           (cl:make-array 0 :element-type 'proto::proxy-block
            :fill-pointer 0 :adjustable cl:t))
  (cl:values))
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
...
(cl:defmethod clear-sections ((self module))
  (cl:setf (cl:slot-value self 'sections)
           (cl:make-array 0 :element-type 'proto::section
            :fill-pointer 0 :adjustable cl:t))
  (cl:values))
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
...
(cl:defmethod clear-aux-data ((self module))
  (cl:setf (cl:slot-value self 'aux-data)
           (cl:make-array 0 :element-type 'proto::module-aux-data-entry
            :fill-pointer 0 :adjustable cl:t))
  (cl:values))
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
...
(cl:defmethod pb:octet-size ((self module-aux-data-entry))
  (cl:let ((size 0))
    ...
    ;; .proto.AuxData value = 2[json_name = "value"];
    (cl:when (cl:logbitp 1 (cl:slot-value self '%has-bits%))
          ...
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:let ((message (cl:slot-value self 'value)))
              (cl:when (cl:null message)
                (cl:setf message (cl:make-instance 'proto::aux-data))
...
(cl:defmethod pb:octet-size ((self module))
  (cl:let ((size 0))
    ...
    ;; .proto.FileFormat file_format = 5[json_name = "fileFormat"];
    (cl:when (cl:logbitp 4 (cl:slot-value self '%has-bits%))
      (cl:incf size 1)
      (cl:incf size (varint:length64 (cl:ldb (cl:byte 64 0) (cl:slot-value self 'file-format)))))
    ;; .proto.ISA isa = 6[json_name = "isa"];
    (cl:when (cl:logbitp 5 (cl:slot-value self '%has-bits%))
      (cl:incf size 1)
    ...
    (cl:when (cl:logbitp 11 (cl:slot-value self '%has-bits%))
      ...
      (cl:incf size (cl:let ((s (cl:length (cl:slot-value self 'entry-point))))
        (cl:+ s (varint:length32 s)))))
    ;; repeated .proto.Symbol symbols = 9[json_name = "symbols"];
    ...
    ;; repeated .proto.ProxyBlock proxies = 16[json_name = "proxies"];
    (cl:let* ((v (cl:slot-value self 'proxies))
      ...
      (cl:dotimes (i length)
        (cl:let ((s (pb:octet-size (cl:aref v i))))
          (cl:incf size (cl:+ s (varint:length32 s))))))
    ;; repeated .proto.Section sections = 12[json_name = "sections"];
    (cl:let* ((v (cl:slot-value self 'sections))
      ...
      (cl:dotimes (i length)
        (cl:let ((s (pb:octet-size (cl:aref v i))))
          (cl:incf size (cl:+ s (varint:length32 s))))))
    ;; map<string, .proto.AuxData> aux_data = 17[json_name = "auxData"];
      ...
      (cl:case tag
        ...
        ((74)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:when (cl:> (cl:+ new-index length) limit)
              (cl:error "buffer overflow"))
            (cl:let ((message (cl:make-instance 'proto::symbol)))
              (cl:setf index (pb:merge-from-array message buffer new-index (cl:+ new-index length)))
              (cl:when (cl:not (cl:= index (cl:+ new-index length)))
                (cl:error "buffer overflow"))
        ...
        ((98)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:when (cl:> (cl:+ new-index length) limit)
              (cl:error "buffer overflow"))
            (cl:let ((message (cl:make-instance 'proto::section)))
              (cl:setf index (pb:merge-from-array message buffer new-index (cl:+ new-index length)))
              (cl:when (cl:not (cl:= index (cl:+ new-index length)))
                (cl:error "buffer overflow"))
        ...
        ((130)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:when (cl:> (cl:+ new-index length) limit)
              (cl:error "buffer overflow"))
            (cl:let ((message (cl:make-instance 'proto::proxy-block)))
              (cl:setf index (pb:merge-from-array message buffer new-index (cl:+ new-index length)))
              (cl:when (cl:not (cl:= index (cl:+ new-index length)))
                (cl:error "buffer overflow"))
        ...
        ((138)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:when (cl:> (cl:+ new-index length) limit)
              (cl:error "buffer overflow"))
            (cl:let ((message (cl:make-instance 'proto::module-aux-data-entry)))
              (cl:setf index (pb:merge-from-array message buffer new-index (cl:+ new-index length)))
              (cl:when (cl:not (cl:= index (cl:+ new-index length)))
                (cl:error "buffer overflow"))
