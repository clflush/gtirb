...
(cl:defclass ir (pb:protocol-buffer)
  ...
  (modules
   ...
   :initform (cl:make-array
              0
              :element-type 'proto::module
              :fill-pointer 0 :adjustable cl:t)
   :type (cl:vector proto::module))
  (aux-data
   :accessor aux-data
   :initarg :aux-data
   :initform (cl:make-array
              0
              :element-type 'proto::ir-aux-data-entry
              :fill-pointer 0 :adjustable cl:t)
   :type (cl:vector proto::ir-aux-data-entry))
  (version
   :accessor version
   :initarg :version
   :initform 0
...
(cl:defmethod cl:initialize-instance :after
  ((self ir) cl:&key
                  (uuid cl:nil uuid-p)
                  (modules cl:nil modules-p)
                  (aux-data cl:nil aux-data-p)
                  (version cl:nil version-p)
                  (cfg cl:nil cfg-p)
                  )
  (cl:declare (cl:ignore uuid modules aux-data version cfg))
  (cl:when uuid-p
    (cl:setf (cl:ldb (cl:byte 1 0) (cl:slot-value self '%has-bits%)) 1))
  (cl:when modules-p
    (cl:setf (cl:ldb (cl:byte 1 1) (cl:slot-value self '%has-bits%)) 1))
...
(cl:defmethod clear-modules ((self ir))
  (cl:setf (cl:slot-value self 'modules)
           (cl:make-array 0 :element-type 'proto::module
            :fill-pointer 0 :adjustable cl:t))
  (cl:values))
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
...
(cl:defmethod clear-aux-data ((self ir))
  (cl:setf (cl:slot-value self 'aux-data)
           (cl:make-array 0 :element-type 'proto::ir-aux-data-entry
            :fill-pointer 0 :adjustable cl:t))
  (cl:values))
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
...
(cl:defmethod cfg ((self ir))
  (cl:let ((result (cl:slot-value self 'cfg)))
    (cl:when (cl:null result)
      (cl:setf result (cl:make-instance 'proto::cfg))
...
(cl:defmethod pb:octet-size ((self ir))
  (cl:let ((size 0))
    ...
    ;; .proto.CFG cfg = 7[json_name = "cfg"];
    (cl:when (cl:logbitp 4 (cl:slot-value self '%has-bits%))
      (cl:let ((s (pb:octet-size (cl:slot-value self 'cfg))))
        (cl:incf size (cl:+ 1 s (varint:length32 s)))))
    ;; repeated .proto.Module modules = 3[json_name = "modules"];
    ...
    ;; map<string, .proto.AuxData> aux_data = 5[json_name = "auxData"];
      ...
      (cl:case tag
        ...
        ((26)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:when (cl:> (cl:+ new-index length) limit)
              (cl:error "buffer overflow"))
            (cl:let ((message (cl:make-instance 'proto::module)))
              (cl:setf index (pb:merge-from-array message buffer new-index (cl:+ new-index length)))
              (cl:when (cl:not (cl:= index (cl:+ new-index length)))
                (cl:error "buffer overflow"))
        ...
        ((42)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:when (cl:> (cl:+ new-index length) limit)
              (cl:error "buffer overflow"))
            (cl:let ((message (cl:make-instance 'proto::ir-aux-data-entry)))
              (cl:setf index (pb:merge-from-array message buffer new-index (cl:+ new-index length)))
              (cl:when (cl:not (cl:= index (cl:+ new-index length)))
                (cl:error "buffer overflow"))
        ...
        ((58)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:let ((message (cl:slot-value self 'cfg)))
              (cl:when (cl:null message)
                (cl:setf message (cl:make-instance 'proto::cfg))
