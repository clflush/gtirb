...
(cl:defclass block (pb:protocol-buffer)
  ...
  (code
   ...
   :initarg :code
   :initform cl:nil
   :type (cl:or cl:null proto::code-block))
  (data
   :writer (cl:setf data)
   :initarg :data
   :initform cl:nil
   :type (cl:or cl:null proto::data-block))
  (%has-bits%
   :accessor %has-bits%
   :initform 0
...
(cl:defmethod cl:initialize-instance :after
  ((self block) cl:&key
                  (offset cl:nil offset-p)
                  (code cl:nil code-p)
                  (data cl:nil data-p)
                  )
  (cl:declare (cl:ignore offset code data))
  (cl:when offset-p
...
(cl:defmethod code ((self block))
  (cl:let ((result (cl:slot-value self 'code)))
    (cl:when (cl:null result)
      (cl:setf result (cl:make-instance 'proto::code-block))
...
(cl:defmethod data ((self block))
  (cl:let ((result (cl:slot-value self 'data)))
    (cl:when (cl:null result)
      (cl:setf result (cl:make-instance 'proto::data-block))
          ...
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:let ((message (cl:slot-value self 'code)))
              (cl:when (cl:null message)
                (cl:setf message (cl:make-instance 'proto::code-block))
        ...
        ((26)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:let ((message (cl:slot-value self 'data)))
              (cl:when (cl:null message)
                (cl:setf message (cl:make-instance 'proto::data-block))
...
(cl:defclass byte-interval-symbolic-expressions-entry (pb:protocol-buffer)
  ...
  (value
   ...
   :initarg :value
   :initform cl:nil
   :type (cl:or cl:null proto::symbolic-expression))
  (%has-bits%
   :accessor %has-bits%
   :initform 0
...
(cl:defmethod cl:initialize-instance :after
  ((self byte-interval-symbolic-expressions-entry) cl:&key
                  (key cl:nil key-p)
...
(cl:defmethod value ((self byte-interval-symbolic-expressions-entry))
  (cl:let ((result (cl:slot-value self 'value)))
    (cl:when (cl:null result)
      (cl:setf result (cl:make-instance 'proto::symbolic-expression))
...
(cl:defclass byte-interval (pb:protocol-buffer)
  ...
  (blocks
   ...
   :initform (cl:make-array
              0
              :element-type 'proto::block
              :fill-pointer 0 :adjustable cl:t)
   :type (cl:vector proto::block))
  (symbolic-expressions
   :accessor symbolic-expressions
   :initarg :symbolic-expressions
   :initform (cl:make-array
              0
              :element-type 'proto::byte-interval-symbolic-expressions-entry
              :fill-pointer 0 :adjustable cl:t)
   :type (cl:vector proto::byte-interval-symbolic-expressions-entry))
  (has-address
...
(cl:defmethod cl:initialize-instance :after
  ((self byte-interval) cl:&key
                  (uuid cl:nil uuid-p)
                  (blocks cl:nil blocks-p)
                  (symbolic-expressions cl:nil symbolic-expressions-p)
                  (has-address cl:nil has-address-p)
                  (address cl:nil address-p)
                  (size cl:nil size-p)
                  (contents cl:nil contents-p)
                  )
  (cl:declare (cl:ignore uuid blocks symbolic-expressions has-address address size contents))
  (cl:when uuid-p
    (cl:setf (cl:ldb (cl:byte 1 0) (cl:slot-value self '%has-bits%)) 1))
  (cl:when blocks-p
    (cl:setf (cl:ldb (cl:byte 1 1) (cl:slot-value self '%has-bits%)) 1))
  (cl:when symbolic-expressions-p
    (cl:setf (cl:ldb (cl:byte 1 2) (cl:slot-value self '%has-bits%)) 1))
  (cl:when has-address-p
...
(cl:defmethod clear-blocks ((self byte-interval))
  (cl:setf (cl:slot-value self 'blocks)
           (cl:make-array 0 :element-type 'proto::block
            :fill-pointer 0 :adjustable cl:t))
  (cl:values))
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
...
(cl:defmethod clear-symbolic-expressions ((self byte-interval))
  (cl:setf (cl:slot-value self 'symbolic-expressions)
           (cl:make-array 0 :element-type 'proto::byte-interval-symbolic-expressions-entry
            :fill-pointer 0 :adjustable cl:t))
  (cl:values))
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
...
(cl:defmethod pb:octet-size ((self byte-interval-symbolic-expressions-entry))
  (cl:let ((size 0))
    ...
    ;; .proto.SymbolicExpression value = 2[json_name = "value"];
    (cl:when (cl:logbitp 1 (cl:slot-value self '%has-bits%))
        ...
        ((18)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:let ((message (cl:slot-value self 'value)))
              (cl:when (cl:null message)
                (cl:setf message (cl:make-instance 'proto::symbolic-expression))
  ...
  (cl:let ((size 0))
    ...
    (cl:when (cl:logbitp 6 (cl:slot-value self '%has-bits%))
      ...
      (cl:incf size (cl:let ((s (cl:length (cl:slot-value self 'contents))))
        (cl:+ s (varint:length32 s)))))
    ;; repeated .proto.Block blocks = 2[json_name = "blocks"];
    ...
    ;; map<uint64, .proto.SymbolicExpression> symbolic_expressions = 3[json_name = "symbolicExpressions"];
      ...
      (cl:case tag
        ...
        ((18)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:when (cl:> (cl:+ new-index length) limit)
              (cl:error "buffer overflow"))
            (cl:let ((message (cl:make-instance 'proto::block)))
              (cl:setf index (pb:merge-from-array message buffer new-index (cl:+ new-index length)))
              (cl:when (cl:not (cl:= index (cl:+ new-index length)))
                (cl:error "buffer overflow"))
        ...
        ((26)
          (cl:multiple-value-bind (length new-index)
            ...
            (cl:when (cl:> (cl:+ new-index length) limit)
              (cl:error "buffer overflow"))
            (cl:let ((message (cl:make-instance 'proto::byte-interval-symbolic-expressions-entry)))
              (cl:setf index (pb:merge-from-array message buffer new-index (cl:+ new-index length)))
              (cl:when (cl:not (cl:= index (cl:+ new-index length)))
                (cl:error "buffer overflow"))
